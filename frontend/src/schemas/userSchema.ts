...
    cargo: z
    .string()
    .min(1, "O cargo é obrigatório.") // Adicionado: Deve ser uma string não vazia
    .max(50,"Cargo não pode ter mais de 50 caracteres"),
    
    email: z
    .string() // Adicionado: Deve ser uma string
    .email("Email inválido")
    .min(1, "O e-mail é obrigatório"), // Adicionado: Deve ser uma string não vazia
    
    senha: z
    .string()
